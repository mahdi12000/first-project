...
class plattersController extends Controller 
{
    public function platters(Request $request){
        ...
        $platters=Restaurant::join('menu','menu.id_Restaurant','restaurants.id')
                            ->select('restaurants.name','restaurants.timeOpen','restaurants.timeClose','restaurants.main_image','restaurants.id','restaurants.city','restaurants.coins','menu.id','menu.price')
