...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="button-container" href="{{ route('Restaurant.log_out') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
            <button class="sidebar-button">Logout</button>
            <form id="logout-form" action="{{ route('Restaurant.log_out') }}" method="POST" style="display: none;">
                @csrf
            </form>
        </div>
    </div>
