    ...
    <main>
        <table class="styled-table">
            ...
            <tr>
                ...
                <td>{{$restaurant->commandes}}</td>
                <td>{{$restaurant->reservations}}</td>
                <td>{{$restaurant->feedbacks}}</td>
                <td>
                    <form action="{{route('admin.block',['idR'=>$restaurant->id])}}" method="post">
                        @csrf
                        <button type="submit" class="block">@if($restaurant->blocked==true) unblock @else block @endif</button>
                    </form>
                    <form action="{{route('admin.delete',['idR'=>$restaurant->id])}}" method="post">
                        @csrf
