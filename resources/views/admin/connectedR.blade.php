...
<head>
    ...
    <script src="../js/connectedR.js"></script>
    ...
    <main>
        <table class="styled-table">
            <tr>
                <th>id</th>
                <th>name</th>
                <th class="actioins">action</th>
            </tr>
            @foreach($connectedR as $connectedR)
            <tr>
                <td>{{$connectedR->id}}</td>
                <td>{{$connectedR->name}}</td>
                <td class="actioins">
                    <form action="{{route('admin.block_connectedR',['idR'=>$connectedR->id])}}" method="post">
                        @csrf
                        <button type="submit" class="block">@if($connectedR->blocked==false) block @else unblock @endif</button>
                    </form>
                    <form action="{{route('admin.delete',['idR'=>$connectedR->id])}}" method="post">
                        @csrf
                        <button type="submit" class="delete">delete</button>
                    </form>
                </td>
                <td style="display: none;"><input type="hidden" value="{{$connectedR->blocked}}"></td>
            </tr>
            @endforeach
        </table>
    </main>
